...
read -ep " please enter your preferred username: " -i "kureq" username
...
# download kureq seed file
seed_file="ubnt.seed"
if [[ ! -f $tmp/$seed_file ]]; then
    echo -n " downloading $seed_file: "
    download "https://raw.githubusercontent.com/vcas/ubntunattended/master/$seed_file"
fi
